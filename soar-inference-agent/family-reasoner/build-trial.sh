...
FILESDIR="/data/Sources/Soar/soar-inference-agent-test-agent/family-reasoner/trial-files"

# Update this to point to agent root directory (where init and propose
# files go)
#AGENTDIR="/data/Sources/Soar/family-reasoner"
AGENTDIR="/data/Sources/Soar/soar-inference-agent-test-agent/family-reasoner"
